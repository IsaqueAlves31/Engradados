package com.hubymc.engradados.lib.packets;
...
public enum ParticleEffect {
	EXPLOSION_NORMAL("EXPLOSION_NORMAL", 0, "EXPLOSION_NORMAL", 0, "explode", 0, -1,
			new ParticleProperty[] { ParticleProperty.DIRECTIONAL }), EXPLOSION_LARGE("EXPLOSION_LARGE", 1,
					"EXPLOSION_LARGE", 1, "largeexplode", 1, -1,
					new ParticleProperty[0]), EXPLOSION_HUGE("EXPLOSION_HUGE", 2, "EXPLOSION_HUGE", 2, "hugeexplosion",
							2, -1, new ParticleProperty[0]), FIREWORKS_SPARK("FIREWORKS_SPARK", 3, "FIREWORKS_SPARK", 3,
									"fireworksSpark", 3, -1,
									new ParticleProperty[] { ParticleProperty.DIRECTIONAL }), WATER_BUBBLE(
											"WATER_BUBBLE", 4, "WATER_BUBBLE", 4, "bubble", 4, -1,
											new ParticleProperty[] { ParticleProperty.DIRECTIONAL,
													ParticleProperty.REQUIRES_WATER }), WATER_SPLASH("WATER_SPLASH", 5,
															"WATER_SPLASH", 5, "splash", 5, -1,
															new ParticleProperty[] {
																	ParticleProperty.DIRECTIONAL }), WATER_WAKE(
																			"WATER_WAKE", 6, "WATER_WAKE", 6, "wake", 6,
																			7,
																			new ParticleProperty[] {
																					ParticleProperty.DIRECTIONAL }), SUSPENDED(
	...
	private ParticleEffect(String s2, int n2, String s, int n, String name, int id, int requiredVersion,
	...
	public static enum ParticleProperty {
		REQUIRES_WATER("REQUIRES_WATER", 0, "REQUIRES_WATER", 0), REQUIRES_DATA("REQUIRES_DATA", 1, "REQUIRES_DATA",
				1), DIRECTIONAL("DIRECTIONAL", 2, "DIRECTIONAL", 2), COLORABLE("COLORABLE", 3, "COLORABLE", 3);

		private ParticleProperty(String s2, int n2, String s, int n) {
		}
	}
