...
public final class ReflectionUtils {
	...
	public static enum PackageType {
		MINECRAFT_SERVER("MINECRAFT_SERVER", 0, "MINECRAFT_SERVER", 0,
				"net.minecraft.server." + getServerVersion()), CRAFTBUKKIT("CRAFTBUKKIT", 1, "CRAFTBUKKIT", 1,
						"org.bukkit.craftbukkit." + getServerVersion()), CRAFTBUKKIT_BLOCK("CRAFTBUKKIT_BLOCK", 2,
								"CRAFTBUKKIT_BLOCK", 2, CRAFTBUKKIT, "block"), CRAFTBUKKIT_CHUNKIO(
										"CRAFTBUKKIT_CHUNKIO", 3, "CRAFTBUKKIT_CHUNKIO", 3, CRAFTBUKKIT,
										"chunkio"), CRAFTBUKKIT_COMMAND("CRAFTBUKKIT_COMMAND", 4, "CRAFTBUKKIT_COMMAND",
												4, CRAFTBUKKIT, "command"), CRAFTBUKKIT_CONVERSATIONS(
														"CRAFTBUKKIT_CONVERSATIONS", 5, "CRAFTBUKKIT_CONVERSATIONS", 5,
														CRAFTBUKKIT, "conversations"), CRAFTBUKKIT_ENCHANTMENS(
																"CRAFTBUKKIT_ENCHANTMENS", 6, "CRAFTBUKKIT_ENCHANTMENS",
																6, CRAFTBUKKIT, "enchantments"), CRAFTBUKKIT_ENTITY(
																		"CRAFTBUKKIT_ENTITY", 7, "CRAFTBUKKIT_ENTITY",
																		7, CRAFTBUKKIT, "entity"), CRAFTBUKKIT_EVENT(
																				"CRAFTBUKKIT_EVENT", 8,
																				"CRAFTBUKKIT_EVENT", 8, CRAFTBUKKIT,
		...
		private PackageType(String s2, int n2, String s, int n, String path) {
			this.path = path;
		}

		private PackageType(String s2, int n2, String s, int n, PackageType parent, String path) {
